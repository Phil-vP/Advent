...
fn main() {
    ...
    for line in BufReader::new(file).lines() {
        ...
        let range1 = (range1_str.next().unwrap().parse::<u32>().unwrap(), range1_str.next().unwrap().parse::<u32>().unwrap());
        let range2 = (range2_str.next().unwrap().parse::<u32>().unwrap(), range2_str.next().unwrap().parse::<u32>().unwrap());
